    ...
    <div className="bg-white rounded-xl overflow-hidden flex flex-col" style={{ border: "1px solid rgba(0,0,0,0.07)" }}>
      <div className="relative h-40 bg-gray-100">
        ...
        <button onClick={handleRemove} disabled={removing}
          className="absolute top-2 right-2 w-7 h-7 rounded-full flex items-center justify-center bg-white shadow hover:bg-red-50 transition"
      ...
      <div className="px-3 py-3 flex-1 flex flex-col">
        ...
        <button onClick={() => navigate(`/browse-cars/${listing._id}`)}
          className="mt-3 w-full flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-medium text-brand-muted hover:bg-gray-50 transition"
